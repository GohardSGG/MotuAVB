namespace Loupedeck.MotuAVBPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MotuAVBPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MotuAVBPlugin.Resources.Resource.txt`.
